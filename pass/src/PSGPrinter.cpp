...
struct PSGPrinter : public FunctionPass {
  ...
  bool runOnFunction(Function &F) override {
    string Filename = ("psg." + F.getName() + ".dot").str();
    ...
    if (!EC) {
      ...
      WriteGraph(File, (const PdgSccGraph *)&psg.getPSG());
    } else {
...
RegisterPass<PSGPrinter>
    PSGPrinterRegister("dot-psg", "Print PDG Strongly Connected Components Graph of function to 'dot' file");
